...
private:
	...
	UCHAR current_animaiton_frame_;
...
public:
	AnimateObject(UINT object_id, UINT object_bitmap_id, const UCHAR& posX, const UCHAR& posY, const UCHAR& width,
		const UCHAR& height, BOOL is_loop, UCHAR animation_size, UCHAR current_animaiton_frame,
		...
		: Object(object_id, object_bitmap_id, posX, posY, width, height),
		  ...
		  current_animaiton_frame_(current_animaiton_frame),
